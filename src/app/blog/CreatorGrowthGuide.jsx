...
const GUIDES = {
  ...
  "28-day-social-media-content-calendar": {
    ...
    links: [
      ...
      ["/blog/what-is-zyvo-publish", "What is Zyvo Publish?", "The full guide to scheduling and posting explained."],
      ["/blog/how-often-should-you-post", "How often should you actually post?", "A realistic answer based on where your account is right now."],
      ["/blog/multi-format-weekly-calendar", "Build a multi-format weekly lineup", "A sample week that spreads several Zyvo formats across different moods."],
    ],
  ...
  "youtube-analytics-for-creators": {
    ...
    links: [
      ...
      ["/blog/what-is-zyvo-stats", "What is Zyvo Stats?", "The full guide to the analytics dashboard explained."],
    ],
  ...
  "short-form-video-metrics-that-matter": {
    ...
    links: [
      ...
      ["/blog/tiktok-algorithm-explained", "What actually gets videos seen", "The signals that consistently correlate with reach on TikTok."],
    ],
