...
const ALL_BLOGS = [
  ...
  { to: "/blog/ai-fruit-story-character-ideas", title: "AI Fruit Story Character Ideas and Storylines", desc: "Try eight fruit-character pairings with clear conflicts and adaptable story hooks.", date: "May 27, 2026", category: "Go Viral", img: "/viral-builder/ai-fruit/presets/cheats-back.webp" },
  { to: "/blog/ai-fruit-story-talking-dialogue-tips", title: "How to Write Talking Dialogue for AI Fruit Story Videos", desc: "How mouth-synced talking characters work, plus five dialogue techniques that make fruit drama hit harder.", date: "Aug 8, 2026", category: "Go Viral", img: "/viral-builder/ai-fruit/characters/orangemom.png" },
  { to: "/blog/ai-fruit-story-vs-traditional-animation", title: "AI Fruit Story vs Traditional Animation", desc: "An honest side-by-side on speed, cost, skill, and character consistency for viral TikTok drama videos.", date: "Aug 8, 2026", category: "Go Viral", img: "/viral-builder/ai-fruit/presets/custom.webp" },
