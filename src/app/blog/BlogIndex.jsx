...
const ALL_BLOGS = [
  ...
  { to: "/blog/viral-ai-fruit-drama-videos", title: "AI Fruit Drama Videos: Story Structure and Workflow", desc: "Understand the conflict, pacing, and scene progression behind short-form fruit-drama videos.", date: "May 14, 2026", category: "Go Viral", img: "/blog-assets/ai-fruit-story-drama-hero.png" },
  { to: "/blog/how-to-go-viral-tiktok-fruit-drama", title: "How to Improve AI Fruit Drama Videos for TikTok", desc: "Test clearer hooks, story angles, publishing cadence, and audience feedback without relying on growth guarantees.", date: "May 15, 2026", category: "Go Viral", img: "/blog-assets/ai-fruit-story-tiktok-strategy-hero.png" },
  { to: "/ai-fruit-story-maker", title: "AI Fruit Story Maker", desc: "Generate a multi-scene cinematic fruit drama video from one idea, with talking characters and animated scenes.", date: "May 14, 2026", category: "Go Viral", img: "/viral-builder/ai-fruit/presets/custom.webp" },
  { to: "/blog/best-ai-fruit-story-ideas", title: "50 AI Fruit Story Prompts and Viral Drama Ideas", desc: "Fifty fruit-drama prompts across reveal, family, friendship, comeback, workplace, and wedding-drama plots.", date: "May 15, 2026", category: "Go Viral", img: "/blog-assets/ai-fruit-story-ideas-hero.png" },
  { to: "/blog/ai-fruit-story-character-ideas", title: "AI Fruit Story Character Ideas and Storylines", desc: "Try eight fruit-character pairings with clear conflicts and adaptable story hooks.", date: "May 27, 2026", category: "Go Viral", img: "/blog-assets/ai-fruit-story-characters-hero.png" },
  { to: "/blog/ai-fruit-story-talking-dialogue-tips", title: "How to Write Talking Dialogue for AI Fruit Story Videos", desc: "How mouth-synced talking characters work, plus five dialogue techniques that make fruit drama hit harder.", date: "Aug 8, 2026", category: "Go Viral", img: "/blog-assets/ai-fruit-story-dialogue-hero.png" },
  { to: "/blog/ai-fruit-story-vs-traditional-animation", title: "AI Fruit Story vs Traditional Animation", desc: "An honest side-by-side on speed, cost, skill, and character consistency for viral TikTok drama videos.", date: "Aug 8, 2026", category: "Go Viral", img: "/blog-assets/ai-fruit-story-vs-animation-hero.png" },
  { to: "/blog/ai-fruit-story-prompt-formula", title: "How to Write the Perfect AI Fruit Story Prompt (Formula + Examples)", desc: "A repeatable 6-part prompt formula, weak-vs-strong examples, and a formula variant for each drama type.", date: "Aug 9, 2026", category: "Go Viral", img: "/blog-assets/ai-fruit-story-prompt-formula-thumb.png" },
  { to: "/blog/ai-fruit-story-instagram-youtube-shorts", title: "How to Post AI Fruit Story Videos on Instagram Reels and YouTube Shorts", desc: "Platform-by-platform differences and a repeatable cross-posting workflow beyond TikTok.", date: "Aug 9, 2026", category: "Go Viral", img: "/blog-assets/ai-fruit-story-shorts-reels-thumb.png" },
  { to: "/blog/ai-fruit-story-plot-twists", title: "The Wildest AI Fruit Story Plot Twists (And How to Write Your Own)", desc: "Five twist structures that outperform a straightforward reveal, with real examples and a repeatable method.", date: "Aug 10, 2026", category: "Go Viral", img: "/blog-assets/ai-fruit-story-plot-twist-hero.png" },
  { to: "/blog/ai-fruit-story-couples", title: "The Most Iconic AI Fruit Story Couples (And How to Ship Your Own)", desc: "Four pairing dynamics worth building a series around, and how to design your own.", date: "Aug 10, 2026", category: "Go Viral", img: "/blog-assets/ai-fruit-story-couples-hero.png" },
  { to: "/blog/ai-fruit-story-duets-stitches", title: "How to Use TikTok Duets and Stitches to Make Your AI Fruit Story Go Viral", desc: "How to structure a video so it's built to get duetted and stitched.", date: "Aug 10, 2026", category: "Go Viral", img: "/blog-assets/ai-fruit-story-duets-hero.png" },
  { to: "/blog/ai-fruit-story-series-universe", title: "How to Build an AI Fruit Story Series (Turn One Video Into a Cinematic Universe)", desc: "Four pillars of a fruit story universe and a simple way to start your first series.", date: "Aug 11, 2026", category: "Go Viral", img: "/blog-assets/ai-fruit-story-universe-hero.png" },
  { to: "/blog/ai-fruit-story-mistakes", title: "10 Mistakes Killing Your AI Fruit Story Views (And How to Fix Each One)", desc: "The ten most common structural mistakes, with a specific fix for each one.", date: "Aug 11, 2026", category: "Go Viral", img: "/blog-assets/ai-fruit-story-mistakes-hero.png" },
  { to: "/blog/best-time-to-post-ai-content", title: "Best Time to Post AI Content to Go Viral in 2026", desc: "Platform-by-platform posting windows, why early engagement beats a fixed clock, and how AI content removes the scheduling bottleneck.", date: "Aug 11, 2026", category: "Go Viral", img: "/blog-assets/best-time-to-post-ai-content-hero.png" },
  { to: "/blog/ai-content-hooks-captions-that-go-viral", title: "How to Write Hooks and Captions for AI Content That Goes Viral", desc: "Five hook formulas, a caption structure that keeps viewers watching, and a simple hashtag strategy.", date: "Aug 11, 2026", category: "Go Viral", img: "/blog-assets/ai-content-hooks-captions-hero.png" },
  { to: "/cartoon-drive-by-video-maker", title: "Cartoon Drive-By Video Maker", desc: "Turn a fictional cartoon or game-inspired destination into a 10-second vertical drive-by video with realistic motion and parallax.", date: "Aug 11, 2026", category: "Go Viral", img: "/blog-assets/cartoon-drive-by-video-ideas-hero.png" },
  { to: "/footballer-nationality-swap-ai", title: "Footballer Nationality Swap AI", desc: "Picture any footballer representing a different nation with a photorealistic jersey swap and a talking media-day introduction clip.", date: "Aug 11, 2026", category: "Go Viral", img: "/template/nationality-swap/preview.png" },
  { to: "/behind-the-scenes-video-maker", title: "Behind the Scenes AI Video Maker", desc: "Generate movie-set footage of a giant practical disaster hitting a handcrafted miniature city, with a full effects crew for scale.", date: "Aug 15, 2026", category: "Go Viral", img: "/behind-the-scenes/poster.webp" },
  { to: "/blog/behind-the-scenes-trend-explained", title: "What Is the \"Behind the Scenes\" AI Video Trend?", desc: "Why the miniature movie-set disaster format works and how to make your first episode.", date: "Aug 16, 2026", category: "Go Viral", img: "/blog-assets/behind-the-scenes-trend-explained-hero.png" },
  { to: "/blog/behind-the-scenes-how-its-made", title: "Why AI \"Movie Set\" Miniature Disaster Videos Look So Real", desc: "The five locked ingredients that sell the illusion every time.", date: "Aug 16, 2026", category: "Go Viral", img: "/blog-assets/behind-the-scenes-how-its-made-hero.png" },
  { to: "/blog/behind-the-scenes-video-ideas", title: "30 Behind the Scenes AI Video Ideas You Can Generate Right Now", desc: "18 curated place-and-disaster combos across every module.", date: "Aug 16, 2026", category: "Go Viral", img: "/blog-assets/behind-the-scenes-video-ideas-hero.png" },
  { to: "/blog/behind-the-scenes-camera-vantage", title: "Tank Edge, Gantry, or Crane Follow? Choosing the Right Camera Angle", desc: "What each camera vantage does to the shot, and when to use it.", date: "Aug 16, 2026", category: "Go Viral", img: "/blog-assets/behind-the-scenes-camera-vantage-hero.png" },
  { to: "/blog/behind-the-scenes-series", title: "How to Turn One Behind the Scenes Video Into a Series", desc: "Four pillars of a consistent season, and a simple way to start your first one.", date: "Aug 16, 2026", category: "Go Viral", img: "/blog-assets/behind-the-scenes-series-hero.png" },
  { to: "/blog/whats-hot-right-now-ai-trends", title: "What's Hot Right Now: 8 AI Video Trends Creators Are Riding in 2026", desc: "What each current AI video format is, why it's working, and where to generate your first one.", date: "Aug 16, 2026", category: "Go Viral", img: "/blog-assets/whats-hot-right-now-ai-trends-hero.png" },
  { to: "/blog/how-to-spot-viral-ai-trend", title: "How to Spot the Next Viral AI Trend Before It Blows Up", desc: "Five signals that show up before a format explodes, and what to do once you've spotted one.", date: "Aug 16, 2026", category: "Go Viral", img: "/blog-assets/how-to-spot-viral-ai-trend-hero.png" },
  { to: "/blog/imperfect-ai-videos-winning", title: "Why \"Imperfect\" AI Videos Are Beating Polished Content Right Now", desc: "The authenticity trick behind the biggest AI video formats of 2026.", date: "Aug 16, 2026", category: "Go Viral", img: "/blog-assets/imperfect-ai-videos-winning-hero.png" },
  { to: "/blog/footballer-nationality-swap-explained", title: "What Is Footballer Nationality Swap? (And How It Works)", desc: "Why the format works, what actually gets generated, and how to create a clip in Zyvo.", date: "Aug 13, 2026", category: "Go Viral", img: "/blog-assets/footballer-nationality-swap-explained-hero.png" },
  { to: "/blog/footballer-nationality-swap-tips", title: "5 Tips for the Most Believable Footballer Nationality Swap Video", desc: "Jersey contrast, expression, background style, and spoken-line length — five choices that make the clip land.", date: "Aug 13, 2026", category: "Go Viral", img: "/blog-assets/footballer-nationality-swap-tips-hero.png" },
  { to: "/blog/cartoon-drive-by-explained", title: "What Is a Cartoon Drive-By Video? (And How to Make One)", desc: "Why the format works, what makes the parallax motion feel real, and how to generate one in Zyvo.", date: "Aug 11, 2026", category: "Go Viral", img: "/blog-assets/cartoon-drive-by-explained-hero.png" },
  { to: "/blog/cartoon-drive-by-video-ideas", title: "15 Cartoon Drive-By Video Ideas (With Prompts You Can Copy)", desc: "Fifteen fictional destinations across car, train, bus, and plane viewpoints, each with a ready-to-use prompt.", date: "Aug 11, 2026", category: "Go Viral", img: "/blog-assets/cartoon-drive-by-video-ideas-hero.png" },
