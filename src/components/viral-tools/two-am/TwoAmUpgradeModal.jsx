...
import { PLAN_LABELS } from "./api/twoAmApi";

const MODEL_COPY = {
  "twoam-v3": {
    title: "V3 is a Pro feature",
    body: "V3 renders your night at 2K — sharper detail than V2's 1K. It's available starting on the Pro plan.",
  },
  "twoam-v4": {
    title: "V4 is a Generative feature",
    body: "V4 renders your night at full 4K — the sharpest, most detailed slideshow 2AM Worlds can produce. It's available on the Generative plan.",
  },
};

export default function TwoAmUpgradeModal({ open, onClose, modelId, requiredPlan }) {
  if (!open) return null;
