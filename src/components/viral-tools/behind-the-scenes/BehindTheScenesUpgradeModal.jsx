...
import { PLAN_LABELS } from "./api/behindTheScenesApi";

const MODEL_COPY = {
  "bts-v3": {
    title: "V3 is a Pro feature",
    body: "V3 renders your episode at 4K with 720p video — sharper detail than V2. It's available starting on the Pro plan.",
  },
  "bts-v4": {
    title: "V4 is a Generative feature",
    body: "V4 renders your episode at full 4K with 1080p video — the sharpest, most detailed Behind the Scenes episode. It's available on the Generative plan.",
  },
};

export default function BehindTheScenesUpgradeModal({ open, onClose, modelId, requiredPlan }) {
  if (!open) return null;
