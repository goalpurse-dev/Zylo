...
import { PLAN_LABELS } from "./api/faceAsmrApi";
...
const MODEL_COPY = {
  ...
  "face-v4": {
    ...
    body: "V4 renders at full 1080p on Vidu Q3 Turbo — the sharpest, most detailed output Face ASMR can produce, with audio included. It's available on the Generative plan.",
  },
};

export default function FaceAsmrUpgradeModal({ open, onClose, modelId, requiredPlan }) {
  if (!open) return null;
