...
import { PLAN_LABELS } from "./api/footballerNationalitySwapApi";

const MODEL_COPY = {
  "footballer-v3": {
    title: "V3 is a Pro feature",
    body: "V3 switches the video engine to Vidu Q3 Turbo at full 1080p — sharper detail and cleaner motion than V2. It's available starting on the Pro plan.",
  },
  "footballer-v4": {
...
export default function FootballerUpgradeModal({ open, onClose, modelId, requiredPlan }) {
  if (!open) return null;
  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        <div className="relative mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-[#F5C042]/20 to-[#F59E0B]/20 border border-[#F5C042]/30">
