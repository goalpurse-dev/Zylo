...
import { PLAN_LABELS } from "./api/fruitStoryApi";

const MODEL_COPY = {
  "fruit-v3": {
    title: "V3 is a Pro feature",
    body: "V3 switches the video engine to Vidu Q3 Turbo at 720p — sharper detail, cleaner motion, and real audio baked into every clip instead of silence. It's available starting on the Pro plan.",
  },
  "fruit-v4": {
    title: "V4 is a Generative feature",
    body: "V4 renders on Veo 3.1 Lite at full resolution — the sharpest, most detailed clips AI Fruit Story can produce, with audio included. It's available on the Generative plan.",
  },
};

export default function FruitStoryUpgradeModal({ open, onClose, modelId, requiredPlan }) {
  if (!open) return null;
  ...
  return createPortal(
    ...
    >
      ...
      >
        {/* subtle premium glaze in the background */}
        <div
