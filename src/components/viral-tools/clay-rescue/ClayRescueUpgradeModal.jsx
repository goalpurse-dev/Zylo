...
import { PLAN_LABELS } from "./api/clayRescueApi";
...
const MODEL_COPY = {
  ...
  "clay-v4": {
    ...
    body: "V4 renders at full 1080p on Vidu Q3 Turbo — the sharpest, most detailed output Clay Rescue can produce, with audio included. It's available on the Generative plan.",
  },
};

export default function ClayRescueUpgradeModal({ open, onClose, modelId, requiredPlan }) {
  if (!open) return null;
