...
export default function proof() {
    return (
        <section>
         ...
         <h1 className="text-[#110829] text-xl font-bold sm sm:text-[35px] lg:text-[30px] xl:text-[40px]">Testimonials</h1> 
         </div> 
        ...
        <div className="flex flex-col">
            ...
            <div className="bg-white shadow-xl h-[300px] lg:h-[400px] w-full mx-2 rounded-xl
              xl:w-[300px] md:w-[200px] md:h-[300px]
            ">

             <img src={R1} className="rounded-full h-16 mt-3 ml-3 lg:mt-5 xl:mt-8"/>

             <h3 className="text-[#110829] text-[25px] sm:text-[26px] md:text-[12px] lg:text-[16px] xl:text-[18px] font-bold py-2 sm:py-3  px-3 ">Daniel R. — Content Creator</h3>
            ...
            <p className="text-[#110829] font-semibold text-[10px] sm:text-[12px] lg:text-[14px] xl:text-[16px] px-2 py-3 sm:py-5 ">4.7/5 <span>⭐⭐⭐⭐⭐</span> </p>
              ...
              <div className="mt-10 sm:mt-4 flex justify-center md:mt-20">
            <div className="bg-white shadow-xl h-[350px] lg:h-[450px] w-full mx-2 rounded-xl
             xl:w-[300px] md:w-[200px] md:h-[400px]
            ">

             <img src={R4} className="rounded-full  h-14   mt-3 ml-3 lg:mt-5 xl:mt-8"/>
  ...
  <div className="mt-10 sm:mt-4 flex justify-center md:mt-20">
            <div className="bg-white shadow-xl h-[350px] lg:h-[420px] w-full mt-2 rounded-xl mx-2
             xl:w-[300px] md:w-[200px] md:h-[330px]
            ">

             <img src={R2} className="rounded-full  h-14   mt-3 ml-3 lg:mt-5 xl:mt-8"/>
  ...
  <div className="mt-10 sm:mt-4 flex justify-center md:mt-20">
            <div className="bg-white shadow-xl h-[320px] lg:h-[380px] w-full mt-2 rounded-xl mx-2
             xl:w-[300px] md:w-[200px] md:h-[320px]
            ">

             <img src={R3} className="rounded-full  h-14   mt-3 ml-3 lg:mt-5 xl:mt-8"/>
...
<div className="flex flex-col md:flex-row gap-3 mx-auto justify-center">
        <div className="mt-10 sm:mt-16 flex justify-center ">
              <div className="bg-white shadow-xl h-[260px] lg:h-[380px] w-full mt-2 rounded-xl mx-2
             xl:w-[300px] md:w-[200px] md:h-[320px]
            ">

             <img src={R5} className="rounded-full  h-14   mt-3 ml-3 lg:mt-5 xl:mt-8"/>
  ...
  <div className="mt-10 sm:mt-16 flex justify-center">
            <div className="bg-white shadow-xl h-[250px] lg:h-[400px] w-[clamp(150px,12vw,300px)] mx-2 rounded-xl
            sm:w-[200px] sm:h-[350px] xl:w-[300px]
            ">

             <img src={R6} className="rounded-full  h-14   mt-3 ml-3 lg:mt-5 xl:mt-8"/>
  ...
  <div className="mt-10 sm:mt-16 flex justify-center">
            <div className="bg-white shadow-xl h-[250px] lg:h-[450px] w-[clamp(150px,12vw,300px)] rounded-xl mx-2
            sm:w-[200px] sm:h-[320px] xl:w-[300px]
            ">

             <img src={R7} className="rounded-full  h-14   mt-3 ml-3 lg:mt-5 xl:mt-8"/>
            ...
            <p className="text-[#110829] font-semibold text-[10px] sm:text-[12px] lg:text-[14px] xl:text-[16px] px-3 py-4 sm:py-5 ">4.7/5 <span>⭐⭐⭐⭐⭐</span> </p>
              ...
              <div className="mt-10 sm:mt-16 flex justify-center">
            <div className="bg-white shadow-xl h-[250px] lg:h-[390px] w-[clamp(150px,12vw,300px)] rounded-xl mx-2
            sm:w-[200px] sm:h-[330px] xl:w-[300px]
            ">

             <img src={R8} className="rounded-full  h-14   mt-3 ml-3 lg:mt-5 xl:mt-8"/>
            ...
            <p className="text-[#110829] font-semibold text-[10px] sm:text-[12px] lg:text-[14px] xl:text-[16px] px-3 py-4 sm:py-5 ">4.7/5 <span>⭐⭐⭐⭐⭐</span> </p>
             ...
             <div className="bg-[linear-gradient(to_bottom,rgba(247,245,250,0)_0%,#F7F5FA_33%,#ECE8F2_45%)] w-full h-40 mx-auto">   
