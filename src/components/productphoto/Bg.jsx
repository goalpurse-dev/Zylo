...
export default function bg() {
    return (
        ...
        <div className="flex justify-center">
         <h1 className="text-[#F4F6FB] text-[20px] font-semibold md:text-[24px]">200+ Backgrounds</h1>
        </div>
        ...
        <div className="mt-10 pb-10">
            ...
            <div className="relative bg-[#141622] h-[340px] w-full shadow-lg overflow-hidden">

                  
                   <div className="">
                   <div className="bg-gradient-to-r from-[#141622]/0 from-0% via-[#141622] via-[70%] to-[#141622] to-100% h-full w-[20px] z-20 absolute right-0 top-0"></div> 
                  </div>
               ...
               <div className="scroll-loop absolute left-0 top-1/2  -translate-y-1/2  ">
                ...
                <div className="py-6 px-3 flex gap-3 justify-center overflow-hidden  ">
                 ...
                 <img className="h-[120px] w-[100px] bg-black rounded-lg " src={Example3}></img>
                   ...
                   <div className="">
                   <div className="bg-gradient-to-l from-[#141622]/0 from-0% via-[#141622] via-[70%] to-[#141622] to-100% h-full w-[20px] z-20 absolute left-0 top-0"></div> 
                  </div>
      ...
      <div className="flex justify-center mt-12">
       ...
       className="bg-[#1A1D2B] border-[#1F2230] border-2 text-[#E6E8EE] rounded-lg px-6 py-2">Browse All</Link> 
      </div>
