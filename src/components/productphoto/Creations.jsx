...
export default function creations() {
    ...
    <div>
         <div className="flex justify-center">
            <h1 className="text-[#F4F6FB] text-[20px] font-semibold md:text-[24px]" > Made With Zylo</h1>    
        </div>


        {/* Creations */}
        <div>
         <div className="relative bg-[#141622] w-full h-[250px] shadow-lg mt-6 overflow-hidden">
            
       <div className="">
                   <div className="bg-gradient-to-r from-[#1F2230]/0 from-0% via-[#1F2230] via-[70%] to-[#141622] to-100% h-full w-[20px] z-20 absolute right-0 top-0"></div> 
                  </div>
   ...
   <img className="h-[140px] w-[100px] bg-black rounded-lg " src={Example3}></img>  
     ...
     <div className="">
                   <div className="bg-gradient-to-l from-[#1F2230]/0 from-0% via-[#1F2230] via-[70%] to-[#141622] to-100% h-full w-[20px] z-20 absolute left-0 top-0"></div> 
                  </div>
