// src/components/ShowcaseReels.jsx
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600">
            Autoplaying, looped, and sized for Reels/Shorts—exactly how your
            audience sees them.
          </p>
        </div>
        ...
        <div
          ref={wrapRef}
          className="
            relative mt-8 overflow-x-auto overflow-y-hidden scroll-smooth
          ...
          <div className="flex gap-5 min-w-max px-8">
            {REELS.map((r, i) => (
              <figure
                key={i}
                className="
                  relative w-[220px] md:w-[260px] aspect-[9/16]
              ...
              >
                ...
                <figcaption
                  className="
                    absolute left-2.5 bottom-2.5 text-[11px] px-2 py-1 rounded-md
                    bg-white/85 border border-gray-200 backdrop-blur
