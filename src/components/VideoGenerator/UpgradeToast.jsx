...
export default function UpgradeToast({ onClose }) {
  ...
  return (
    <>
      ...
      <div
        className="fixed bottom-6 right-4 md:right-6 z-[999999] w-[340px] max-w-[calc(100vw-2rem)]"
          ...
          <div className="px-5 py-5">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-[#9D6BFF] text-xs font-medium mt-0.5">Starter plan feature</div>
              </div>
              <button
                onClick={onClose}
            ...
            <p className="text-white/60 text-sm leading-relaxed mb-4">
              <span className="text-white font-semibold">AI Video Generator</span> is unlocked on the Starter plan.
