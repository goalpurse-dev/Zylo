...
export default function UpgradeToast({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[999999] flex items-center justify-center animate-[fadeIn_0.25s_ease-out]">
      ...
      >
        ...
        <div className="text-white/70 text-sm mt-3 text-center leading-relaxed">
          Video generation is part of the{" "}
          <span className="text-white font-semibold">Starter plan</span>.
          Upgrade to unlock the AI video generator and all models.
        </div>
        ...
        <div className="text-xs text-white/50 text-center mt-4">
          Most creators unlock video generation to create viral content.
        </div>
